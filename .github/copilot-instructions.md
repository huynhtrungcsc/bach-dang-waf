# BACH DANG WAF — Development Guidelines

## 🎯 Project Overview

BACH DANG WAF is an open-source enterprise Web Application Firewall management console with real-time threat intelligence, ModSecurity integration, and multi-domain protection. The project is built as a monorepo using:
