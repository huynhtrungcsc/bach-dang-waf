...
export const userMutationOptions = {
  ...
  create: {
    ...
    onSuccess: async (_data: { data: User; message: string }) => {
  ...
  resetPassword: {
    ...
    onSuccess: async (_data: { message: string; data?: any }) => {
...
export const useCreateUser = () => {
  ...
  return useMutation({
    ...
    onSuccess: async (data: { data: User; message: string }) => {
      userMutationOptions.create.onSuccess?.(data);
      // Invalidate users list to refresh
      await queryClient.invalidateQueries({ queryKey: userQueryKeys.all });
      await queryClient.refetchQueries({ queryKey: userQueryKeys.all });
...
export const useUpdateUser = () => {
  ...
  return useMutation({
    ...
    onSuccess: async (data: { data: User; message: string }, { id }) => {
