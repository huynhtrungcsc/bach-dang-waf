...
// API Base URL
// In production (Docker), uses relative '/api' so browser always calls same host — no CORS issue.
// Override with VITE_API_URL only when backend is on a different host.
