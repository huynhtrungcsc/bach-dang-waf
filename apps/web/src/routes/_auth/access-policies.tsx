...
export const Route = createFileRoute('/_auth/access-policies')({
  ...
  return (
    <div className="container mx-auto py-6 space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-slate-800">Ingress Access Policies</h1>
          <p className="text-[13px] text-slate-400">
            Control inbound access using IP source allowlists and HTTP Basic Authentication bound to domains
          </p>
        </div>
      </div>
...
export function AccessListsPageSkeleton() {
  return (
