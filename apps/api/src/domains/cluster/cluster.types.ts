 ...
 * Replica Node Status
 */
export type ReplicaNodeStatus = 'online' | 'offline' | 'syncing' | 'error';

/**
 * Replica Node Interface
 */
...
/**
 * Replica Node Response (without sensitive data)
 */
export interface ReplicaNodeResponse {
  id: string;
  name: string;
  host: string;
  port: number;
...
/**
 * Replica Node Creation Response (includes API key ONCE)
 */
export interface ReplicaCreationResponse {
  id: string;
  name: string;
  host: string;
  port: number;
...
/**
 * Extended Request with Replica Node Info
 */
export interface ReplicaRequest extends Request {
  replicaNode?: {
    id: string;
    name: string;
    host: string;
