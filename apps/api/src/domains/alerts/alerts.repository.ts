...
export class NotificationChannelRepository {
   ...
   */
  async insert(data: CreateNotificationChannelDto): Promise<NotificationChannel> {
   ...
   */
  async patch(id: string, data: UpdateNotificationChannelDto): Promise<NotificationChannel> {
...
export class AlertRuleRepository {
   ...
   */
  async listAll(): Promise<AlertRuleWithChannels[]> {
   ...
   */
  async getById(id: string): Promise<AlertRuleWithChannels | null> {
   ...
   * Create alert rule
   */
  async insert(data: CreateAlertRuleDto): Promise<AlertRuleWithChannels> {
   ...
   * Update alert rule
   */
  async patch(id: string, data: UpdateAlertRuleDto): Promise<AlertRuleWithChannels> {
    const updateData: any = {};
    if (data.name) updateData.name = data.name;
