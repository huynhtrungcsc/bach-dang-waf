...
# Managed by BACH DANG WAF - DO NOT EDIT MANUALLY
`;
      ...
      for (const line of lines) {
        ...
        if (line.trim() === '# CRS Rule Disables (managed by BACH DANG WAF)') {
...
This directory contains rule disable configurations managed by BACH DANG WAF.
