...
export class UsersRepository {
   ...
   */
  async listAll(filters: UserQueryDto): Promise<User[]> {
    const where: any = {};
   ...
   * Find user by ID
   */
  async getById(id: string): Promise<UserWithProfile | null> {
   ...
   * Create new user
   */
  async insert(data: CreateUserDto & { password: string }): Promise<User> {
   ...
   * Update user
   */
  async patch(id: string, data: UpdateUserDto): Promise<User> {
