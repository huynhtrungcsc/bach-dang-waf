...
export class SystemConfigRepository {
  ...
  async updateNodeMode(
    configId: string,
    nodeMode: NodeMode,
    resetReplicaConnection: boolean = false
    ...
    // Reset replica connection if switching to primary mode
    if (resetReplicaConnection) {
   ...
   */
  async getById(configId: string): Promise<SystemConfig | null> {
