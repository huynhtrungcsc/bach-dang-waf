...
export class AccessListsRepository {
   ...
   */
  async getById(id: string): Promise<AccessListWithRelations | null> {
   ...
   */
  async getByName(name: string): Promise<AccessListWithRelations | null> {
    return prisma.accessList.findUnique({
      where: { name },
      include: {
        authUsers: true,
   ...
   */
  async insert(data: CreateAccessListInput): Promise<AccessListWithRelations> {
   ...
   */
  async setEnabled(id: string, enabled: boolean): Promise<AccessListWithRelations> {
   ...
   */
  async getByDomainId(domainId: string): Promise<AccessListWithRelations[]> {
