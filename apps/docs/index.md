...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/bach-dang-waf/bach-dang-waf
features:
...
To get started with bach-dang-waf, follow our [installation guide](/guide/installation) and check out the [quick start tutorial](/guide/quick-start).

## Documentation

- [Guide](/guide/introduction) - Learn how to use bach-dang-waf
