...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'author', content: 'Huỳnh Chí Trung (huynhtrungcsc)' }],
    ['meta', { property: 'og:title', content: 'BACH DANG WAF Documentation' }],
    ['meta', { property: 'og:description', content: 'Enterprise Nginx + ModSecurity Management Platform' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:image', content: '/og-image.png' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'BACH DANG WAF Documentation' }],
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/huynhtrungcsc/bach-dang-waf/edit/main/apps/docs/:path',
      text: 'Edit this page on GitHub'
    },

    // Enhanced social links
    socialLinks: [
      { icon: 'github', link: 'https://github.com/huynhtrungcsc/bach-dang-waf' },
    ],

    // Enhanced footer
    footer: {
      message: 'Released under the Apache 2.0 License.',
      copyright: `Copyright © 2025-${new Date().getFullYear()} BACH DANG WAF`
    },
